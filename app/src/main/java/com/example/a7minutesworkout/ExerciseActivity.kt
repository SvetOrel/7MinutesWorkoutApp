...
import com.example.a7minutesworkout.databinding.DialogCustomerBackConfirmationBinding
import java.util.*
...
class ExerciseActivity : AppCompatActivity(), TextToSpeech.OnInitListener {
    ...
    private fun customDialogForBackButton() {
        ...
        val dialogBinding = DialogCustomerBackConfirmationBinding.inflate(layoutInflater)
